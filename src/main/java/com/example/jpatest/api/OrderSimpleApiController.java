...
import com.example.jpatest.repository.query.OrderSimpleQueryRepository;
...
public class OrderSimpleApiController {
    ...
    public List<Order> orderV1() {
        // 엔티티로 전달하면 무한루프 탄다 json 변경에서 서로서로 계속 참조함
        // JsonIgnore,hibernate모듈 등 방법은 있으나 그냥 dto로 주면 복잡한거 다 사라짐
        // V1 쓰지마셈
    ...
    // * 중요
    // select시 컬럼 몇개가 더 있다고 실제 성능에 영향을 줄까?
    // where 또는 join index 같은 것들이 성능에 더 주요한 영향을 미친다.
